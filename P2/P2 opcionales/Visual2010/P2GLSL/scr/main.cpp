...
int main(int argc, char** argv)
{
	...
	IGlib::addAuxiliarTex(objId, "../img/specMap.png");
	...
	IGlib::addAuxiliarTex(objId3, "../img/specMap.png");
...
void idleFunc()
{
	...
	traslacion2 = glm::translate (traslacion2, glm::vec3(-2.3f, 0.0f, 0.0f));
	...
	IGlib::setModelMat(objId3,model2*traslacion2*rotacion2*escalado2);
}
